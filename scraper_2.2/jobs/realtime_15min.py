...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('realtime_15min.log', encoding='utf-8'),
...
def main():
    ...
    try:
        ...
        log_id = db.log_sync_start('realtime_15min', 'realtime', run_id)
    ...
    try:
        ...
        logger.info("\n" + "="*70)
        logger.info("✓ Realtime update completed successfully!")
        logger.info("="*70)
        return 0
