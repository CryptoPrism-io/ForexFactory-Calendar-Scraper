#!/usr/bin/env python3
"""Fetch ForexFactory calendar rows for a week and dump them for inspection."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fetch ForexFactory calendar data for a week.")
    parser.add_argument(
        "--period",
        default="week=this",
        help="Calendar period (day=today, week=this, month=last|this|next).",
    )
    parser.add_argument(
        "--format",
        choices=("text", "json"),
